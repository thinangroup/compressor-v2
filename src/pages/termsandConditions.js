            ...
            <Container maxWidth="md" style={{ background: 'white', marginTop:'10px' }}>
                <div className='rules-main'>
                    ...
                    <p >
                        ...
                        <p style={{ textIndent: '50px' }}>We may collect personal identification information from Users in a variety of ways, including, but not limited to, when Users visit our site, respond to a survey and in connection with other activities, services, features or resources we make available on our Site. Users may be asked for, as appropriate,

                            Users may, however, visit our Site anonymously.</p>

                        <p style={{ textIndent: '50px' }}>We will collect personal identification information from Users only if they voluntarily submit such information to us. Users can always refuse to supply personally identification information, except that it may prevent them from engaging in certain Site related activities.</p>

                        <h2>Non-personal identification information</h2>
                        <p style={{ textIndent: '50px' }}>We may collect non-personal identification information about Users whenever they interact with our Site. Non-personal identification information may include the browser name, the type of computer and technical information about Users means of connection to our Site, such as the operating system and the Internet service providers utilized and other similar information.</p>

                        <h2>Web browser cookies</h2>
                        <p style={{ textIndent: '50px' }}>Our Site may use "cookies" to enhance User experience. User's web browser places cookies on their hard drive for record-keeping purposes and sometimes to track information about them. User may choose to set their web browser to refuse cookies, or to alert you when cookies are being sent. If they do so, note that some parts of the Site may not function properly.</p>

                        <h2>How we use collected information</h2>
                        <p style={{ textIndent: '50px' }}>Thinan Groups collects and uses Users personal information for the following purposes:
                        ...
                        <p style={{ textIndent: '50px' }}>We adopt appropriate data collection, storage and processing practices and security measures
                        ...
                        <p style={{ textIndent: '50px' }}>Thinan Groups has the discretion to update this privacy policy at any time.
                        ...
                        <p style={{ textIndent: '50px' }}>By using this Site, you signify your acceptance of this policy and terms of service.
                        ...
                        <h2>Contacting us</h2>
                        <p style={{ textIndent: '50px' }}>If you have any questions about this Privacy Policy, the practices of this site,
                        ...
                        <p style={{ textIndent: '50px' }}>Sivanthi nagar, Tenkasi</p>

                        <p style={{ textIndent: '50px' }}> thinangroups@gmail.com</p>
                    </p>
                </div>
            </Container>
            <Social />
